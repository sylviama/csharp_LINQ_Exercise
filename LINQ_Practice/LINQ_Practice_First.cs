...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(c=>c.PrimaryInstructor.FirstName.ToLower()=="kate");
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(c=>c.FullTime && c.PrimaryInstructor.Birthday>DateTime.Today);
